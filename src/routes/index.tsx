       ...
       <div className="flex items-center gap-2">
         ...
         <div>
           <h2 className="font-serif text-base font-medium">
             {ar ? "مساعد القراءة الصوتي" : "Voice Reading Assistant"}
           </h2>
           <p className="text-xs text-muted-foreground">
             {ar ? "تحدث واقترح لك قصة" : "Talk to get story suggestions"}
           </p>
         </div>
       </div>
     </div>
     ...
     <div className="p-5">
       ...
       >
         ...
         {thinking
           ...
           : listening
           ? (ar ? "🔴 يستمع... (صمت 3 ث للإرسال)" : "🔴 Listening... (3s silence to send)")
       ...
       {reply && (
         <div className="mt-3 rounded-xl bg-primary/5 border border-primary/20 p-3 text-sm leading-relaxed">
           {reply}
         </div>
       )}
       ...
       {suggestedStories.length > 0 && (
         <div className="mt-4">
           <p className="mb-3 text-xs font-medium text-primary uppercase tracking-wide">
