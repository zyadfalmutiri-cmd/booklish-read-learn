 ...
 head: () => ({
   meta: [
     ...
     { title: "Booklish — Learn English by Reading" },
     {
       name: "description",
       content:
         "Learn English the natural way: read short stories and novels, tap any word for an Arabic + English explanation, and track your progress.",
     },
     { name: "author", content: "Booklish" },
     { property: "og:title", content: "Booklish — Learn English by Reading" },
     {
       property: "og:description",
       content: "Read short stories. Tap any word. Learn English like a reader, not a student.",
     },
