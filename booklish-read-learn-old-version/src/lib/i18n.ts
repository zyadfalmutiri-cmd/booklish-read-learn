...
const DICT: Dict = {
  ...
  "legal.terms": { ar: "شروط الاستخدام", en: "Terms of Service" },
  "legal.cookies": { ar: "سياسة ملفات تعريف الارتباط", en: "Cookie Policy" },
  "legal.navLabel": { ar: "صفحات قانونية", en: "Legal pages" },
  "legal.contact": { ar: "تواصل معنا", en: "Contact us" },
};
